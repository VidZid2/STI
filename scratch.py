...
with open('src/components/tools/LanguageToolGrammarChecker.tsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('src/components/tools/LanguageToolGrammarChecker.tsx', 'w', encoding='utf-8') as f:
    f.write(new_content)
print('Done!')
