                                                    ...
                                                    {calendarData.days.slice(0, 35).map((dayData, i) => {
                                                        ...
                                                        return (
                                                            <motion.div
                                                                ...
                                                                className={`relative rounded-md cursor-pointer ${quickViewSettings.compactMode ? 'text-[9px] py-1' : 'text-[11px] py-1.5'} ${!dayData.isCurrentMonth
                                                                ...
                                                                {calendarData.days.map((dayData, i) => {
                                                                    ...
                                                                    return (
                                                                        <motion.div
                                                                            ...
                                                                            className={`relative rounded-lg text-center cursor-pointer ${quickViewSettings.compactMode ? 'py-1.5' : 'py-2'} ${!dayData.isCurrentMonth
                                                                                    ? 'text-zinc-300'
                                                                                    : dayData.isToday
