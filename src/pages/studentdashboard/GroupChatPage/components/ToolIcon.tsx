/**
 * ToolIcon Component
 * Minimalistic line icons for study tools
 */
...
export const ToolIcon: React.FC<ToolIconProps> = ({ type, color, size = 20 }) => {
    ...
    return <div style={{ color }}>{icons[type] || icons.flashcard}</div>;
};
