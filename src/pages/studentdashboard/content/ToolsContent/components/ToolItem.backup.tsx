...
const ToolItem: React.FC<{
    ...
    const metaBadgeClass = 'inline-flex h-[26px] items-center gap-1 rounded-full border px-2.5 text-[10.5px] font-semibold uppercase leading-none tracking-normal shadow-[0_1px_2px_rgba(15,23,42,0.04)]';
    ...
    return (
        <>
            ...
            <motion.button
                type="button"
                className="group relative flex h-full min-h-[280px] w-full flex-col items-start overflow-hidden rounded-[20px] border border-zinc-200/70 bg-white p-4 text-left shadow-sm transition-[border-color] duration-300 ease-out hover:border-blue-200/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:border-zinc-800/70 dark:bg-zinc-900 dark:hover:border-blue-800/50 dark:focus-visible:ring-offset-zinc-950 sm:min-h-[300px] sm:p-5 lg:p-6"
                ...
                animate={{
                    ...
                    y: isHovered ? -1 : 0,
                    boxShadow: isHovered
                        ? `0 14px 30px -18px ${accent.shadow}, 0 0 0 1px ${accent.shadow}`
                        : '0 4px 12px rgba(2, 6, 23, 0.03), 0 0 0 1px transparent',
                }}
                whileTap={{ scale: 0.99 }}
            ...
            >
                ...
                <div className="relative z-10 flex w-full flex-1 flex-col">
                    <div className="flex w-full items-start justify-between gap-4">
                        <motion.div
                            className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-[14px] border transition-colors duration-300 sm:h-12 sm:w-12 ${isHovered ? accent.iconActive : accent.iconIdle}`}
                        ...
                        <div className="flex flex-wrap items-center justify-end gap-1.5">
                            ...
                            <div className="relative group/tip">
                                <button
                                    ...
                                    className="inline-flex h-[26px] w-[26px] items-center justify-center rounded-full border border-zinc-200 bg-zinc-50/90 text-zinc-500 shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-colors duration-200 hover:bg-zinc-100 hover:text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800/70 dark:text-zinc-300 dark:hover:bg-zinc-700 dark:hover:text-zinc-100"
                    ...
                    {/* Title */}
                    <div className="mt-4 flex min-w-0 flex-col justify-center">
                        <motion.h3
                            className="max-w-full whitespace-normal text-base font-bold leading-snug tracking-tight text-zinc-900 dark:text-zinc-100 sm:text-lg"
                    ...
                    <div className="mt-2 w-full text-left">
                        <p className="text-[13px] leading-relaxed text-zinc-500 dark:text-zinc-400 sm:text-sm">
                            {tool.description}
                        </p>
                    </div>
                    ...
                    {/* Best For */}
                    {tool.bestFor && (
                        <div className="mt-3 w-full rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-3 shadow-sm transition-colors duration-300 group-hover:border-blue-200 dark:border-zinc-700 dark:bg-zinc-800/50 dark:group-hover:border-blue-800">
                            <span className="mb-0.5 block text-[10px] font-bold uppercase tracking-[0.16em] text-blue-500 dark:text-blue-400/70">
                                Best for
                            </span>
                            <span className="block text-[14px] font-semibold leading-snug text-zinc-800 dark:text-zinc-200">
                                {tool.bestFor}
                            </span>
                        </div>
                    )}
                    ...
                    {/* Action footer */}
                    <div className={`mt-auto flex w-full items-center justify-between border-t border-zinc-100 pt-3.5 text-[13px] font-semibold transition-colors duration-300 dark:border-zinc-800/60 ${accent.action}`}>
                        <span className="transition-colors duration-200 group-hover:opacity-100 opacity-70">{tool.onClick ? 'Open workspace' : 'Choose file'}</span>
                        <motion.span animate={{ x: isHovered ? 3 : 0 }} transition={{ type: 'tween', ease: [0.25, 0.46, 0.45, 0.94], duration: 0.25 }} aria-hidden="true">
                        ...
                        <>
                            ...
                            >
                                        ...
                                        >
                                            ...
                                            {/* Progress Bar */}
                                            <div className="absolute left-0 right-0 top-0 h-1.5 bg-zinc-200/80 dark:bg-zinc-700/70">
                                                <motion.div
                                                    initial={{ width: 0 }}
                                                    animate={{ width: `${((currentStep + 1) / resolvedTutorial.steps.length) * 100}%` }}
                                                    transition={{ type: 'spring', damping: 20, stiffness: 300 }}
                                                    className="h-full rounded-r-full bg-gradient-to-r from-blue-500 to-blue-600"
                                                />
                                            </div>
                                            ...
                                            <div className="p-8 relative">
                                                ...
                                                >
                                                    ...
                                                    <motion.div
                                                        ...
                                                        className={`mx-auto mb-4 flex h-14 w-14 shrink-0 items-center justify-center rounded-[16px] border ${accent.iconIdle} shadow-sm ring-4 ring-white/50 dark:ring-zinc-900/50`}
                                                    >
                                                ...
                                                <AnimatePresence mode="wait">
                                                    <motion.div
                                                        ...
                                                        exit={{ opacity: 0, x: -20 }}
                                                        transition={{ duration: 0.25 }}
                                                        className="mb-5 relative overflow-hidden bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-8 group z-10"
                                                    >
                                                ...
                                                <div className="flex items-center justify-center gap-1 mt-2 relative z-10">
                                                    ...
                                                    {currentStep < resolvedTutorial.steps.length - 1 ? (
                                                        <motion.button
                                                            ...
                                                            whileHover={{ y: -1 }}
                                                            whileTap={{ scale: 0.97 }}
                                                            className="flex items-center gap-1.5 px-4 py-2 text-sm font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors"
                                                        >
                                                            Next
                                                            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                                                <path d="M5 12h14" />
                                                ...
                                                <motion.button
                                                    ...
                                                    className="mt-4 w-full flex items-center justify-center gap-1.5 px-4 py-2 text-sm font-bold text-zinc-700 bg-zinc-100 dark:text-zinc-300 dark:bg-zinc-800/50 rounded-xl hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors relative z-10"
                                                >
