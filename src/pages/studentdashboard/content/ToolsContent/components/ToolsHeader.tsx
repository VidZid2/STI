...
export const ToolsHeader: React.FC<ToolsHeaderProps> = ({ totalTools }) => {
    return (
        <motion.div
            ...
            className="mb-8 relative overflow-hidden bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800/80 shadow-sm rounded-[24px] p-6 lg:p-7 flex flex-col md:flex-row items-center justify-between gap-8 group transition-all duration-300 hover:shadow-md hover:border-blue-200/80 dark:hover:border-blue-800/50"
        >
            ...
            <div className="flex flex-wrap items-center gap-4 relative z-10 w-full md:w-auto">
                ...
                <div className="flex items-center gap-4 p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl border border-zinc-100 dark:border-zinc-800 transition-colors hover:shadow-sm hover:border-blue-200 dark:hover:border-blue-800/50">
                    ...
                    <div>
                        <p className="text-[12px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider mb-0.5">Available</p>
                ...
                <div className="flex items-center gap-4 p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl border border-zinc-100 dark:border-zinc-800 transition-colors hover:shadow-sm hover:border-emerald-200 dark:hover:border-emerald-800/50">
                    ...
                    <div>
                        <p className="text-[12px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider mb-0.5">Data</p>
