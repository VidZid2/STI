...
interface SubmitModalProps {
    ...
    setSubmissionFiles: (v: File[]) => void;
                    ...
                    >
                        ...
                        {submitSuccess ? (
                            ...
                            >
                                ...
                                <h3 style={{ fontSize: '22px', fontWeight: 800, marginBottom: '10px', color: isDark ? '#f1f5f9' : '#0f172a' }}>
                                    Submission Successful!
                                </h3>
                                <p style={{ fontSize: '14px', marginBottom: '36px', lineHeight: 1.6, color: isDark ? '#94a3b8' : '#64748b', maxWidth: '90%', margin: '0 auto 36px' }}>
                                ...
                                <motion.button
                                    ...
                                    style={{
                                        margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px',
                                        padding: '10px 32px',
                            ...
                            <>
                                ...
                                <div style={{ padding: '24px 28px 0', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1 }}>
                                        ...
                                        <div>
                                            <h2 style={{ fontSize: '17px', fontWeight: 700, margin: 0, lineHeight: 1.3, color: isDark ? '#f1f5f9' : '#0f172a' }}>
                                                Submit Assignment
                                            </h2>
                                            <p style={{ fontSize: '12px', margin: 0, marginTop: '2px', color: isDark ? '#94a3b8' : '#64748b' }}>
                                                {task.title}
                                            </p>
                                        </div>
                                    </div>
                                    <motion.button
                                        ...
                                        style={{
                                            ...
                                            cursor: 'pointer', flexShrink: 0, color: isDark ? '#94a3b8' : '#94a3b8',
                                        }}
                                    >
                                ...
                                <div style={{ padding: '16px 28px', display: 'flex', gap: '8px', flexWrap: 'wrap' as const }}>
                                    <span style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '4px 10px', borderRadius: '8px', fontSize: '11px', fontWeight: 600, background: isDark ? 'rgba(59, 130, 246, 0.15)' : 'rgba(59, 130, 246, 0.08)', color: '#3b82f6' }}>
                                        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                                            <circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" />
                                        </svg>
                                        {task.due}
                                    </span>
                                    <span style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '4px 10px', borderRadius: '8px', fontSize: '11px', fontWeight: 600, background: isDark ? 'rgba(16, 185, 129, 0.15)' : 'rgba(16, 185, 129, 0.08)', color: '#10b981' }}>
                                        {task.points || 100} pts
                                    </span>
                                    {(task.maxAttempts || 1) > 1 && (
                                        <span style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '4px 10px', borderRadius: '8px', fontSize: '11px', fontWeight: 600, background: isDark ? 'rgba(0, 61, 165, 0.15)' : 'rgba(0, 61, 165, 0.08)', color: '#003DA5' }}>
                                ...
                                {/* Divider */}
                                <div style={{ height: '1px', margin: '0 28px', background: isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.06)' }} />

                                {/* Submission Content */}
                                <div style={{ padding: '20px 28px', flex: 1 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: 700, marginBottom: '8px', color: isDark ? '#94a3b8' : '#64748b', textTransform: 'uppercase' as const, letterSpacing: '0.5px' }}>
                                    ...
                                    <textarea
                                        ...
                                        style={{
                                            ...
                                            borderRadius: '14px', border: `1.5px solid ${isDark ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.08)'}`,
                                    ...
                                    <div style={{ marginTop: '16px' }}>
                                        ...
                                        <FileUpload files={submissionFiles} onChange={setSubmissionFiles} />
                                    </div>
                                </div>

                                {/* Footer */}
                                <div style={{ padding: '16px 28px 24px', display: 'flex', gap: '10px', justifyContent: 'flex-end', borderTop: `1px solid ${isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.04)'}` }}>
                                    <motion.button
                                    ...
                                    <motion.button
                                        ...
                                        style={{
                                            padding: '10px 28px', borderRadius: '12px', fontSize: '13px', fontWeight: 700, border: 'none',
                                            ...
                                            boxShadow: isSubmitting || (!submissionText.trim() && submissionFiles.length === 0) ? 'none' : '0 4px 14px rgba(59, 130, 246, 0.25)',
                                        }}
                                    >
                                        {isSubmitting ? (
                                            <>
