...
const HomeContent: React.FC<HomeContentProps> = ({ onShowWelcomeModal, quickViewSlot }) => {
    ...
    return (
        <div className="w-full h-full px-0 pt-20 pb-28 sm:p-6 sm:pb-8 lg:p-8 max-w-[1400px] mx-auto animate-in fade-in duration-500">
            ...
            {/* Mobile Status Header Banner */}
            <div className="sm:hidden w-full px-4 mb-3">
                <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400 bg-blue-50/50 dark:bg-blue-900/20 px-3 py-2 rounded-[12px] border border-blue-100/50 dark:border-blue-800/30">
                    <svg className="w-3.5 h-3.5 shrink-0 text-blue-500/70 dark:text-blue-400/70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                    </svg>
                    <p className="text-[11px] font-medium leading-[1.3] truncate">
                        <span className="text-blue-700 dark:text-blue-300 font-bold tracking-wide">Overview ready.</span>{" "}
                        Track your courses and momentum.
                    </p>
                </div>
            </div>
