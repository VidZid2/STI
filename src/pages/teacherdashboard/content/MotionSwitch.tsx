...
export function Switch({ checked, onCheckedChange, disabled, label, className, 'aria-label': ariaLabel }: SwitchProps) {
  const id = useId();
      ...
      <span className={cn("inline-flex items-center gap-3", className)}>
        <motion.button
          ...
          className={cn(
            ...
            "border",
            checked ? "justify-end" : "justify-start shadow-inner",
          )}
          style={{
