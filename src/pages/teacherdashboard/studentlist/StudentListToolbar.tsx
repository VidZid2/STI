...
const StudentListToolbar: React.FC<StudentListToolbarProps> = ({
    ...
    >
        ...
        {!isMobile && (
            <div className="flex relative overflow-visible rounded-[10px]"
                ...
                {viewTooltip.visible && (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-[10px] whitespace-nowrap"
                            ...
                            <div>
                                <div className="text-xs font-semibold tracking-[0.01em]" style={{ color: 'var(--text-primary)' }}>
                                    {viewTooltip.type === 'list' ? 'List View' : 'Grid View'}
                                </div>
                                <div className="text-[11px] mt-px" style={{ color: 'var(--text-secondary)' }}>
        ...
        {!isSmallMobile && (
            <div className="relative">
                <motion.button
                    ...
                    className="flex items-center gap-1.5 rounded-[10px] font-medium cursor-pointer"
                    style={{
                ...
                <AnimatePresence>
                    {showExportMenu && (
                        <motion.div
                            ...
                            className="absolute top-[calc(100%+8px)] right-0 rounded-xl overflow-hidden z-[100] min-w-[180px]"
                        ...
                        >
                            {[
                                ...
                                <React.Fragment key={format}>
                                    {i > 0 && <div className="h-px mx-3" style={{ background: 'var(--border-subtle)' }} />}
                                    <motion.button
                                        whileHover={{ background: bg }}
                                        onClick={() => handleExport(format)}
                                        className="flex items-center gap-2.5 w-full px-4 py-3 border-none bg-transparent cursor-pointer text-[13px] font-medium text-left"
