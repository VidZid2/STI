    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-white dark:bg-slate-800 border border-black/5 dark:border-white/5 shadow-sm relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col gap-3">
                ...
                <div className="text-3xl font-black text-slate-900 dark:text-slate-100 tracking-tight flex items-baseline gap-2">
        ...
        <div className="p-5 rounded-2xl bg-white dark:bg-slate-800 border border-black/5 dark:border-white/5 shadow-sm relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col gap-3">
                ...
                <div className={`text-3xl font-black tracking-tight flex items-center gap-2.5 ${stats?.systemHealth === 'Operational' ? 'text-emerald-500' : 'text-amber-500'}`}>
