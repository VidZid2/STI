...
const DEMO_USERS: UserAccount[] = [
    ...
    { id: 'student-2', student_id: '02000543211', email: 'delacruz.juan@meycauayan.sti.edu.ph', full_name: 'Juan Dela Cruz', first_name: 'Juan', last_name: 'Dela Cruz', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: true, last_active: new Date(Date.now() - 15 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-3', student_id: '02000543212', email: 'santos.maria@meycauayan.sti.edu.ph', full_name: 'Maria Santos', first_name: 'Maria', last_name: 'Santos', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date().toISOString(), created_at: new Date().toISOString() },
    { id: 'student-4', student_id: '02000543213', email: 'reyes.pedro@meycauayan.sti.edu.ph', full_name: 'Pedro Reyes', first_name: 'Pedro', last_name: 'Reyes', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: true, last_active: new Date(Date.now() - 45 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-5', student_id: '02000543214', email: 'cruz.ana@meycauayan.sti.edu.ph', full_name: 'Ana Cruz', first_name: 'Ana', last_name: 'Cruz', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: true, last_active: new Date().toISOString(), created_at: new Date().toISOString() },
    { id: 'student-6', student_id: '02000543215', email: 'mendoza.jose@meycauayan.sti.edu.ph', full_name: 'Jose Mendoza', first_name: 'Jose', last_name: 'Mendoza', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-7', student_id: '02000543216', email: 'bautista.luz@meycauayan.sti.edu.ph', full_name: 'Luz Bautista', first_name: 'Luz', last_name: 'Bautista', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: true, last_active: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-8', student_id: '02000543217', email: 'torres.miguel@meycauayan.sti.edu.ph', full_name: 'Miguel Torres', first_name: 'Miguel', last_name: 'Torres', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 45 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-9', student_id: '02000543218', email: 'villanueva.rosa@meycauayan.sti.edu.ph', full_name: 'Rosa Villanueva', first_name: 'Rosa', last_name: 'Villanueva', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-10', student_id: '02000543219', email: 'navarro.carlos@meycauayan.sti.edu.ph', full_name: 'Carlos Navarro', first_name: 'Carlos', last_name: 'Navarro', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: true, last_active: new Date().toISOString(), created_at: new Date().toISOString() },
    { id: 'student-11', student_id: '02000543220', email: 'ramos.elena@meycauayan.sti.edu.ph', full_name: 'Elena Ramos', first_name: 'Elena', last_name: 'Ramos', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 20 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-12', student_id: '02000543221', email: 'mercado.luis@meycauayan.sti.edu.ph', full_name: 'Luis Mercado', first_name: 'Luis', last_name: 'Mercado', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: true, last_active: new Date(Date.now() - 20 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-13', student_id: '02000543222', email: 'castro.carmen@meycauayan.sti.edu.ph', full_name: 'Carmen Castro', first_name: 'Carmen', last_name: 'Castro', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-14', student_id: '02000543223', email: 'deleon.manuel@meycauayan.sti.edu.ph', full_name: 'Manuel De Leon', first_name: 'Manuel', last_name: 'De Leon', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-15', student_id: '02000543224', email: 'gonzales.teresa@meycauayan.sti.edu.ph', full_name: 'Teresa Gonzales', first_name: 'Teresa', last_name: 'Gonzales', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-16', student_id: '02000543225', email: 'aquino.antonio@meycauayan.sti.edu.ph', full_name: 'Antonio Aquino', first_name: 'Antonio', last_name: 'Aquino', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 10 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-17', student_id: '02000543226', email: 'fernandez.clara@meycauayan.sti.edu.ph', full_name: 'Clara Fernandez', first_name: 'Clara', last_name: 'Fernandez', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-18', student_id: '02000543227', email: 'morales.francisco@meycauayan.sti.edu.ph', full_name: 'Francisco Morales', first_name: 'Francisco', last_name: 'Morales', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date().toISOString(), created_at: new Date().toISOString() },
    { id: 'student-19', student_id: '02000543228', email: 'perez.isabel@meycauayan.sti.edu.ph', full_name: 'Isabel Perez', first_name: 'Isabel', last_name: 'Perez', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 25 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-20', student_id: '02000543229', email: 'gomez.vicente@meycauayan.sti.edu.ph', full_name: 'Vicente Gomez', first_name: 'Vicente', last_name: 'Gomez', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-21', student_id: '02000543230', email: 'domingo.sofia@meycauayan.sti.edu.ph', full_name: 'Sofia Domingo', first_name: 'Sofia', last_name: 'Domingo', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 7 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-22', student_id: '02000543231', email: 'pascual.ramon@meycauayan.sti.edu.ph', full_name: 'Ramon Pascual', first_name: 'Ramon', last_name: 'Pascual', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 35 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-23', student_id: '02000543232', email: 'tolentino.beatriz@meycauayan.sti.edu.ph', full_name: 'Beatriz Tolentino', first_name: 'Beatriz', last_name: 'Tolentino', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 6 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-24', student_id: '02000543233', email: 'garcia.eduardo@meycauayan.sti.edu.ph', full_name: 'Eduardo Garcia', first_name: 'Eduardo', last_name: 'Garcia', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date().toISOString(), created_at: new Date().toISOString() },
    { id: 'student-25', student_id: '02000543234', email: 'ocampo.leonor@meycauayan.sti.edu.ph', full_name: 'Leonor Ocampo', first_name: 'Leonor', last_name: 'Ocampo', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 50 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-26', student_id: '02000543235', email: 'lopez.arturo@meycauayan.sti.edu.ph', full_name: 'Arturo Lopez', first_name: 'Arturo', last_name: 'Lopez', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 7 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-27', student_id: '02000543236', email: 'martinez.rosalinda@meycauayan.sti.edu.ph', full_name: 'Rosalinda Martinez', first_name: 'Rosalinda', last_name: 'Martinez', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 9 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-28', student_id: '02000543237', email: 'cruz.ricardo@meycauayan.sti.edu.ph', full_name: 'Ricardo Cruz', first_name: 'Ricardo', last_name: 'Cruz', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 40 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-29', student_id: '02000543238', email: 'santiago.magdalena@meycauayan.sti.edu.ph', full_name: 'Magdalena Santiago', first_name: 'Magdalena', last_name: 'Santiago', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: false, last_active: new Date(Date.now() - 8 * 60 * 60 * 1000).toISOString(), created_at: new Date().toISOString() },
    { id: 'student-30', student_id: '02000543239', email: 'flores.fernando@meycauayan.sti.edu.ph', full_name: 'Fernando Flores', first_name: 'Fernando', last_name: 'Flores', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: true, last_active: new Date().toISOString(), created_at: new Date().toISOString() },
    { id: 'demo-user-1', student_id: '02000543210', email: 'deasis.462124@meycauayan.sti.edu.ph', full_name: 'Josiah P. De Asis', first_name: 'Josiah', last_name: 'De Asis', role: 'student', campus: 'Meycauayan', program: 'BSIT', year_level: '1st Year', section: 'BSIT101A', is_active: true, is_online: true, last_active: new Date().toISOString(), created_at: new Date().toISOString() },
];
