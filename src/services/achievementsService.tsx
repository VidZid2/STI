...
const ACHIEVEMENT_DEFINITIONS: Omit<Achievement, 'unlocked' | 'unlockedAt' | 'progress'>[] = [
    ...
    },
    {
        id: 'easter-egg-tae',
        name: 'Tae Lang',
        description: 'Discovered the secret motivational message. Kaya mo yan boss!',
        icon: '💩',
        category: 'special',
        requirement: 'Find the 1-in-100 Easter egg message',
        rarity: 'legendary',
    },
];
    ...
    return ACHIEVEMENT_DEFINITIONS.map(def => {
        ...
        switch (def.id) {
            ...
            case 'perfect-week':
                ...
                break;
            case 'easter-egg-tae':
                unlocked = savedUnlocks['easter-egg-tae'] !== undefined;
                progress = unlocked ? 100 : 0;
                break;
        }
