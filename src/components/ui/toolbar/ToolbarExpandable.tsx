                        ...
                        <div className='flex items-center gap-0.5 sm:gap-2 lg:gap-3' ref={menuRef}>
                            {ITEMS.map((item) => (
                                <motion.button
                                    ...
                                    transition={{ type: 'spring', stiffness: 400, damping: 15 }}
                                    className={cn(
                                        'relative flex shrink-0 select-none appearance-none items-center justify-center transition-all duration-300 focus-visible:ring-2 shadow-sm border w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-xl sm:rounded-2xl',
                                        active === item.id
