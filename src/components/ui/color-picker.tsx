    ...
    >
      ...
      <div className="relative">
        ...
        <div className="relative z-10 mt-2 flex items-center gap-2 text-foreground">
          {format === "HEX" ? (
            <>
              <div className="flex items-center gap-1.5 bg-zinc-100/80 dark:bg-zinc-800/50 px-3 py-1.5 rounded-lg border border-zinc-200/80 dark:border-zinc-700/80 focus-within:ring-2 focus-within:ring-zinc-200 dark:focus-within:ring-zinc-800 focus-within:border-zinc-300 dark:focus-within:border-zinc-600 transition-all shadow-sm">
                <span className="font-medium text-sm text-zinc-500 dark:text-zinc-400">
                  #
                </span>
                <input
                  type="text"
                  className="w-16 !bg-transparent font-medium text-sm tracking-wide uppercase !border-none !outline-none focus:!ring-0 focus:!outline-none focus:!border-transparent !p-0 !m-0 !shadow-none text-zinc-900 dark:text-zinc-100 appearance-none color-picker-input-reset"
                  style={{ background: 'transparent', border: 'none', outline: 'none', boxShadow: 'none', WebkitAppearance: 'none' }}
                  onBlur={() => {
              ...
              <ChannelInput
                ...
                suffix="%"
                value={alpha}
                className="w-16 flex-none text-right justify-end"
              />
            </>
          ) : null}
          {format === "RGB" ? (
...
function ChannelInput({
  ...
  return (
    <div className={cn("flex min-w-0 items-center justify-center gap-1 bg-zinc-100/80 dark:bg-zinc-800/50 px-2.5 py-1.5 rounded-lg border border-zinc-200/80 dark:border-zinc-700/80 focus-within:ring-2 focus-within:ring-zinc-200 dark:focus-within:ring-zinc-800 focus-within:border-zinc-300 dark:focus-within:border-zinc-600 transition-all shadow-sm", className || "flex-1")}>
      <input
        aria-label={suffix ? `Value ${suffix}` : "Channel value"}
        type="text"
        className="flex-1 min-w-0 !bg-transparent text-center font-medium text-sm tabular-nums !border-none !outline-none focus:!ring-0 focus:!outline-none focus:!border-transparent !p-0 !m-0 !shadow-none text-zinc-900 dark:text-zinc-100 appearance-none color-picker-input-reset"
        style={{ background: 'transparent', border: 'none', outline: 'none', boxShadow: 'none', WebkitAppearance: 'none' }}
        inputMode="decimal"
        onBlur={() => {
          setFocused(false);
      ...
      />
      {suffix ? (
        <span className="text-zinc-500 dark:text-zinc-400 font-medium text-xs flex-none">{suffix}</span>
      ) : null}
    </div>
  );
}
