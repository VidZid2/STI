...
// @ts-ignore
                                        ...
                                        >
                                            ...
                                            <div className={`w-10 h-10 rounded-[12px] flex items-center justify-center shrink-0 shadow-sm border ${
                                                isReached 
                                                    ...
                                                    : "bg-slate-50 border-slate-200 text-slate-400 dark:bg-slate-800/50 dark:border-slate-700/50 dark:text-slate-500"
                                            }`}>
    ...
    return createPortal(
        <AnimatePresence>
            {isOpen && (
                <div key="level-modal-container" style={{
                    position: 'fixed',
                    inset: 0,
                    zIndex: 99998,
                    display: 'flex',
                                            ...
                                            >
                                                <div className="relative flex items-center justify-center">
                                                    ...
                                                    <button
                                                        ...
                                                        className={cn(
                                                            "relative z-10 w-[76px] h-[62px] rounded-[50%] flex items-center justify-center transition-all duration-150 outline-none active:translate-y-[8px] cursor-pointer overflow-hidden",
                                                            isLocked
                                                                ? "bg-zinc-200 dark:bg-zinc-800 text-zinc-400 dark:text-zinc-650 shadow-[0_8px_0_0_#d4d4d8,inset_0_2px_0_0_rgba(255,255,255,0.5)] dark:shadow-[0_8px_0_0_#18181b,inset_0_2px_0_0_rgba(255,255,255,0.05)] active:shadow-[0_0px_0_0_#d4d4d8,inset_0_2px_0_0_rgba(255,255,255,0.5)] dark:active:shadow-[0_0px_0_0_#18181b,inset_0_2px_0_0_rgba(255,255,255,0.05)] hover:bg-zinc-250 dark:hover:bg-zinc-750"
                                                                : isCurrent
                                                                    ? "bg-[#fbbf24] bg-[linear-gradient(140deg,rgba(255,255,255,0.4)_0%,rgba(255,255,255,0.15)_35%,transparent_50%,rgba(0,0,0,0.06)_80%,rgba(0,0,0,0.1)_100%)] text-blue-600 shadow-[0_8px_0_0_#d97706,inset_0_-2px_0_0_rgba(0,0,0,0.12),inset_0_2px_0_0_rgba(255,255,255,0.45)] active:shadow-[0_0px_0_0_#d97706,inset_0_-2px_0_0_rgba(0,0,0,0.12),inset_0_2px_0_0_rgba(255,255,255,0.45)] hover:bg-[#f5b020]"
                                                                    : "bg-[#facc15] bg-[linear-gradient(140deg,rgba(255,255,255,0.4)_0%,rgba(255,255,255,0.15)_35%,transparent_50%,rgba(0,0,0,0.06)_80%,rgba(0,0,0,0.1)_100%)] text-blue-600 shadow-[0_8px_0_0_#ca8a04,inset_0_-2px_0_0_rgba(0,0,0,0.12),inset_0_2px_0_0_rgba(255,255,255,0.45)] active:shadow-[0_0px_0_0_#ca8a04,inset_0_-2px_0_0_rgba(0,0,0,0.12),inset_0_2px_0_0_rgba(255,255,255,0.45)] hover:bg-[#efc00e]"
                                                        )}
                                                        style={{
