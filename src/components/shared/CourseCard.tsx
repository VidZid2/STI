    ...
    >
      ...
      <div className="card-image-container">
        <div
          ...
          style={{
            transform:
              !prefersReducedMotion && isHovered ? "scale(1.03)" : "scale(1)",
      ...
      <div className="card-body-premium">
          ...
          {deadline ? (
            ...
            >
              ...
              <motion.p
                ...
                animate={
                  prefersReducedMotion ? undefined : { x: isHovered ? 4 : 0 }
                }
        ...
        <div className="card-progress-section">
          <div className="card-progress-premium">
            ...
            >
              <div
                className={`progress-bar-container ${progressHovered ? "hovered" : ""}`}
              >
                <motion.div
                ...
                {progressHovered && (
                  ...
                  >
                    <div className="progress-tooltip-content">
                      <span className="progress-tooltip-value">
                        {progress}%
                      </span>
                    ...
                    <div className="progress-tooltip-details">
                      <span>
                        {Math.round((progress / 100) * modules)}/{modules}{" "}
                        modules
                      </span>
                    </div>
                  </motion.div>
