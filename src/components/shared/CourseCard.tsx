...
const CourseCard = ({
    ...
    const animationDelay = prefersReducedMotion ? 0 : Math.min(index * 0.03, 0.15);
                    ...
                    <div className="card-title-row">
                        ...
                        {unreadCount && unreadCount > 0 && (
                            <motion.div
                                ...
                                transition={{ delay: 0.25 + index * 0.06, type: 'spring', stiffness: 400, damping: 15 }}
                                whileHover={{ scale: 1.1 }}
                            >
                        ...
                        >
                            <div className={`progress-bar-container ${progressHovered ? 'hovered' : ''}`}>
                                <motion.div
                                    ...
                                    transition={{
                                        width: { duration: 0.8, delay: 0.2 + index * 0.1, ease: [0.25, 0.1, 0.25, 1] },
                                ...
                                <motion.div
                                    ...
                                    animate={{ opacity: progressHovered ? 1 : 0, scale: progressHovered ? 1 : 0 }}
                ...
                <div className="card-actions-premium">
                    ...
                    <div className="quick-actions-wrapper" ref={quickActionsRef}>
                        <motion.button
                            ...
                            onClick={(e) => { e.stopPropagation(); setQuickActionsOpen(!quickActionsOpen); }}
                            whileHover={prefersReducedMotion ? undefined : { 
                                scale: 1.1,
                                boxShadow: quickActionsOpen ? '0 0 0 4px rgba(251, 191, 36, 0.15)' : '0 0 0 4px rgba(59, 130, 246, 0.15)'
                            }}
                            whileTap={{ scale: 0.92 }}
                            animate={{ rotate: quickActionsOpen ? 45 : 0, borderColor: quickActionsOpen ? '#fbbf24' : '#3b82f6' }}
                        ...
                        >
                            <motion.svg 
                                ...
                                initial={false}
                                animate={{ stroke: quickActionsOpen ? '#fbbf24' : '#3b82f6', scale: quickActionsOpen ? 1.1 : 1 }}
                                transition={{ stroke: { duration: 0.2, ease: [0.4, 0, 0.2, 1] }, scale: { type: 'spring', stiffness: 600, damping: 20 } }}
                            >
                                <motion.path d="M12 5v14" initial={false} animate={{ pathLength: 1, opacity: 1 }} />
                                <motion.path d="M5 12h14" initial={false} animate={{ pathLength: 1, opacity: 1 }} />
                            </motion.svg>
                        </motion.button>
                                ...
                                >
                                    {quickActions.map((action, actionIndex) => (
                                        <motion.button
                                            ...
                                            animate={{ opacity: 1, y: 0 }}
                                            transition={{ delay: prefersReducedMotion ? 0 : actionIndex * 0.04, type: 'spring', stiffness: 500, damping: 30 }}
                                            whileHover={prefersReducedMotion ? undefined : { x: 3, transition: { type: 'spring', stiffness: 400, damping: 20 } }}
                                            whileTap={{ scale: 0.98 }}
                                        >
                                            <motion.span className="quick-action-icon" whileHover={prefersReducedMotion ? undefined : { scale: 1.1, transition: { type: 'spring', stiffness: 400, damping: 15 } }}>
                                                {action.icon}
                                            </motion.span>
                                            <motion.span className="quick-action-label" initial={{ opacity: 0.8 }} whileHover={{ opacity: 1 }}>
                                                {action.label}
                                            </motion.span>
                                        </motion.button>
                                    ))}
        ...
        >
            ...
            <div className="skeleton-body">
                <div className="skeleton-title-section">
                    <motion.div className="skeleton-title" animate={{ opacity: [0.5, 0.8, 0.5] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut' }} />
                    <motion.div className="skeleton-subtitle" animate={{ opacity: [0.4, 0.7, 0.4] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.1 }} />
                </div>
                <div className="skeleton-content">
                    <motion.div className="skeleton-preview-box" animate={{ opacity: [0.4, 0.6, 0.4] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.2 }} />
                </div>
                <div className="skeleton-stats">
                    <motion.div className="skeleton-stat-box" animate={{ opacity: [0.4, 0.6, 0.4] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.3 }} />
                </div>
                <div className="skeleton-progress">
                    <div className="skeleton-progress-info">
                        <motion.div className="skeleton-progress-text" animate={{ opacity: [0.5, 0.7, 0.5] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.4 }} />
                        <motion.div className="skeleton-modules-text" animate={{ opacity: [0.4, 0.6, 0.4] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.45 }} />
                    </div>
                    <motion.div className="skeleton-progress-bar" animate={{ opacity: [0.3, 0.5, 0.3] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }} />
                </div>
                <div className="skeleton-actions">
                    <motion.div className="skeleton-btn-primary" animate={{ opacity: [0.5, 0.7, 0.5] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.55 }} />
                    <motion.div className="skeleton-btn-secondary" animate={{ opacity: [0.4, 0.6, 0.4] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.6 }} />
                </div>
            </div>
        </motion.div>
    );
