...
INSERT INTO courses (id, title, short_title, subtitle, modules, category, instructor, image) VALUES
    ('cp1', 'Computer Programming 1', 'CP1', 'CITE1003 Â· BSIT101A', 1, 'major', 'David Clarence Del Mundo', 'https://images.unsplash.com/photo-1517180102446-f3ece451e9d8?w=300&h=200&fit=crop&crop=center'),
    ('itc', 'Introduction to Computing', 'ITC', 'CITE1004 Â· BSIT101A', 1, 'major', 'Psalmmiracle Mariano', 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=300&h=200&fit=crop&crop=center'),
    ('euth1', 'Euthenics 1', 'EUTH1', 'STIC1002 Â· BSIT101A', 1, 'ge', 'Claire Maurillo', 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=300&h=200&fit=crop&crop=center'),
    ('purcom', 'Purposive Communication', 'PURCOM', 'GEDC1016 Â· BSIT101A', 1, 'ge', 'John Denielle San Martin', 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=300&h=200&fit=crop&crop=center'),
    ('tcw', 'The Contemporary World', 'TCW', 'GEDC1002 Â· BSIT101A', 1, 'ge', 'Anne Jenell Lumintigar', 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=300&h=200&fit=crop&crop=center'),
    ('uts', 'Understanding the Self', 'UTS', 'GEDC1008 Â· BSIT101A', 1, 'ge', 'Jocel Lazalita', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=200&fit=crop&crop=center'),
    ('ppc', 'Philippine Popular Culture', 'PPC', 'GEDC1041 Â· BSIT101A', 1, 'ge', 'Claire Maurillo', 'https://images.unsplash.com/photo-1533900298318-6b8da08a523e?w=300&h=200&fit=crop&crop=center'),
    ('pe1', 'P.E./PATHFIT 1', 'PE1', 'PHED1005 Â· BSIT101A', 1, 'pe', 'Mark Joseph Danoy', 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=300&h=200&fit=crop&crop=center'),
    ('nstp1', 'NSTP 1', 'NSTP1', 'NSTP1008 Â· BSIT101A', 1, 'nstp', 'Dan Risty Montojo', 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=300&h=200&fit=crop&crop=center')
...
VALUES 
    ('msg-demo-1', 'bsit101a-study-group', '02000543210', 'Josiah De Asis', 'Welcome to our study group! ðŸŽ‰ Feel free to share resources and ask questions.', 'text', NOW() - INTERVAL '2 hours'),
...
```', 'text', NOW() - INTERVAL '30 minutes'),
    ...
    ('msg-demo-5', 'bsit101a-study-group', '02000543215', 'Blake Cedrick Baldivas', '**Flashcard** ðŸ“š
